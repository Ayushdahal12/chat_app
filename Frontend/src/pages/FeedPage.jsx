    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .feed-header { position: sticky; top: 0; z-index: 100; background: rgba(250,250,248,0.88); backdrop-filter: blur(24px) saturate(180%); border-bottom: 1px solid var(--border); padding: 14px 20px; display: flex; align-items: center; justify-content: space-between; }
        .feed-header-left { display: flex; align-items: center; gap: 12px; }
        .back-btn { width: 38px; height: 38px; border-radius: 50%; border: 1.5px solid var(--border); background: var(--surface); display: flex; align-items: center; justify-content: center; cursor: pointer; color: var(--ink); box-shadow: var(--shadow-sm); transition: all 0.2s; }
        .back-btn:hover { transform: translateX(-2px); box-shadow: var(--shadow-md); }
        .feed-logo { font-family: 'Syne', sans-serif; font-weight: 800; font-size: 22px; letter-spacing: -0.5px; color: var(--ink); }
        .feed-logo span { color: #1960F1; }
        .post-btn { display: flex; align-items: center; gap: 6px; background: var(--ink); color: white; border: none; cursor: pointer; padding: 10px 18px; border-radius: 100px; font-family: 'Syne', sans-serif; font-weight: 700; font-size: 13px; letter-spacing: 0.3px; box-shadow: 0 4px 14px rgba(0,0,0,0.2); transition: all 0.2s; }
        ...
        .post-card { background: var(--surface); border-radius: var(--radius); border: 1px solid var(--border); box-shadow: var(--shadow-sm); overflow: hidden; transition: box-shadow 0.3s; animation: fadeUp 0.4s ease both; }
        ...
        .post-username { font-family: 'Syne', sans-serif; font-weight: 700; font-size: 14px; color: var(--ink); }
        .post-time { font-size: 11px; color: var(--ink-faint); font-weight: 500; letter-spacing: 0.3px; margin-top: 1px; }
        .delete-btn { width: 34px; height: 34px; border-radius: 10px; border: none; background: transparent; cursor: pointer; display: flex; align-items: center; justify-content: center; color: var(--ink-faint); transition: all 0.2s; }
        ...
        .post-likes { font-family: 'Syne', sans-serif; font-weight: 700; font-size: 13px; color: var(--ink); margin-bottom: 6px; }
        .post-caption { font-size: 14px; line-height: 1.55; color: var(--ink); }
        .post-caption strong { font-weight: 700; margin-right: 6px; }
        .view-comments { background: none; border: none; cursor: pointer; font-size: 12px; font-weight: 600; color: var(--ink-soft); letter-spacing: 0.3px; margin-top: 6px; display: block; transition: color 0.2s; }
        .view-comments:hover { color: var(--blue); }
        .feed-loader { display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 60vh; gap: 16px; color: var(--ink-soft); }
        ...
        .empty-title { font-family: 'Syne', sans-serif; font-weight: 800; font-size: 20px; color: var(--ink); }
        .empty-sub { font-size: 14px; color: var(--ink-soft); max-width: 200px; }
        .empty-cta { margin-top: 8px; padding: 12px 28px; background: var(--ink); color: white; border: none; border-radius: 100px; font-family: 'Syne', sans-serif; font-weight: 700; font-size: 14px; cursor: pointer; transition: all 0.2s; box-shadow: 0 4px 14px rgba(0,0,0,0.2); }
        ...
        .modal-title { font-family: 'Syne', sans-serif; font-weight: 800; font-size: 20px; color: var(--ink); }
        ...
        .caption-input { width: 100%; margin-top: 14px; padding: 14px 16px; border-radius: var(--radius-sm); border: 1.5px solid var(--border); background: var(--paper-2); font-family: 'DM Sans', sans-serif; font-size: 14px; color: var(--ink); resize: none; outline: none; transition: border-color 0.2s; line-height: 1.6; }
        .caption-input:focus { border-color: var(--ink); background: white; }
        .caption-input::placeholder { color: var(--ink-faint); }
        .share-btn { width: 100%; margin-top: 14px; padding: 16px; background: var(--ink); color: white; border: none; cursor: pointer; border-radius: var(--radius-sm); font-family: 'Syne', sans-serif; font-weight: 800; font-size: 15px; letter-spacing: 0.3px; box-shadow: 0 4px 20px rgba(0,0,0,0.2); transition: all 0.2s; display: flex; align-items: center; justify-content: center; gap: 8px; }
        ...
        .comment-modal-header { padding: 22px 22px 0; display: flex; align-items: center; justify-content: space-between; border-bottom: 1px solid var(--border); padding-bottom: 16px; flex-shrink: 0; }
        ...
        .comment-author { font-family: 'Syne', sans-serif; font-weight: 700; font-size: 12px; color: var(--blue); margin-bottom: 3px; }
        .comment-text { font-size: 13px; color: var(--ink); line-height: 1.5; }
        .no-comments { text-align: center; padding: 40px 20px; color: var(--ink-faint); font-size: 14px; font-weight: 500; }
        ...
        .comment-input { flex: 1; background: none; border: none; outline: none; font-family: 'DM Sans', sans-serif; font-size: 13px; color: var(--ink); }
